        ...
        >
            ...
            <div>
                ...
                <div className="socials flex flex-row gap-2">
                    <Link href="https://github.com/hardroners">
                        <Image src={GithubIcon} alt="Github Icon" />
                    </Link>
                    <Link href="https://www.linkedin.com/in/nicolashovette/">
            ...
            <div>
                <form className="flex flex-col">
                    ...
                    <button
                        type="submit"
                        className="bg-blue-500 hover:bg-blue-300 text-white font-medium py-2.5 px-5 rounded-lg w-full"
                    >
                        Send Message
                    </button>
                </form>
